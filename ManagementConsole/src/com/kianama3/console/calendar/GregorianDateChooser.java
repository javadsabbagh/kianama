...
public class GregorianDateChooser extends JDialog implements ItemListener,
		MouseListener, FocusListener, KeyListener, ActionListener {
	
	private static final long serialVersionUID = 137462467464L;
	/* Names of the months. */
	private static final String[] MONTHS = new String[] { "ژانویه",
			"فوریه", "مارس", "آوریل", "می", "جون", "جولای", "اوت",
			"سپتامبر", "اکتبر", "نوامبر", "دسامبر" };
	/* Names of the days of the week. */
	private static final String[] DAYS = new String[] { "یکشنبه", "دوشنبه", "سه شنبه",
	...
	private static class FocusablePanel extends JPanel {
		 ...
		 * layout manager.  @param layout layout manager
		 */
		 ...
		 * <code>FocusablePanel</code> can receive the focus.  @return
		 * <code>true</code>
		 */
	 ...
	 * selected label in the calendar to get the day. * * @return the selected
	 * day or -1 if there is no day selected
	 **/
	 ...
	 * the calendar, corresponding to the day to select. * * @param newDay day
	 * to select
	 **/
	 ...
	 * control to select. * * @param newDay day to select
	 **/
	...
	/**
	 * * Constructs a new <code>DateChooser</code> with the given title. * * @param
	 * owner owner dialog * * @param title dialog title
	 **/
	public GregorianDateChooser(Dialog owner, String title) {
		super(owner, title, true);
		construct();
	}

	/**
	 * * Constructs a new <code>DateChooser</code>. * * @param owner owner
	 * dialog
	 **/
	public GregorianDateChooser(Dialog owner) {
		super(owner, true);
		construct();
	}
	...
	/**
	 * * Constructs a new <code>DateChooser</code> with the given title. * * @param
	 * owner owner frame * * @param title dialog title
	 **/
	public GregorianDateChooser(Frame owner, String title) {
		super(owner, title, true);
		construct();
	}

	/**
	 * * Constructs a new <code>DateChooser</code>. * * @param owner owner frame
	 * @wbp.parser.constructor
	 **/
	public GregorianDateChooser(Frame owner) {
		super(owner, true);
		construct();
	}
	 ...
	 * selected date, and allows the user select a new date. * * @param date
	 * initial date * * @return the new date selected or <code>null</code> if the
	 * user * press "Cancel" or closes the dialog box
	 **/
	 ...
	 * date as the parameter. * * @return the same as the function
	 * {@link #select(Date)}
	 **/
	public Date select() {
